...
import { EnvironmentProviders, importProvidersFrom, inject, Provider, provideEnvironmentInitializer, provideAppInitializer, Injector } from '@angular/core';
    ...
    if (config?.mockApi?.services) {
        providers.push(
            ...
            provideAppInitializer(() => {
                ...
                config.mockApi.services.forEach(service => injector.get(service));
                return;
            })
        );
    }
